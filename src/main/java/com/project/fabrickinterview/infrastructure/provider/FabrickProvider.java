...
import com.project.fabrickinterview.domain.cashaccount.model.CashAccountDto;
...
public class FabrickProvider {
    ...
    public Optional<CashAccountListResponse> getAllCashAccounts(Long accountId, String from, String to) {
        return getWebClient()
                .get()
                .uri(uriBuilder -> uriBuilder
                        ...
                        .build())
                .retrieve()
                .bodyToMono(CashAccountListResponse.class)
    ...
    protected WebClient getWebClient() {
        return webClientBuilder
                ...
                .defaultHeader("X-Time-Zone", TimeZone.getDefault().getID())
                .build();
    }
}
